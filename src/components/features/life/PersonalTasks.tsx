...
export default function PersonalTasks() {
  const [tasks, setTasks] = useLocalStorage<Task[]>('personalTasks', []);
  ...
  return (
    <BentoCard title="المهام الشخصية" contentClassName="p-0">
      <div className="flex flex-col h-full">
        ...
        <ScrollArea className="h-[250px] flex-grow">
          <div className="p-4">
            {tasks.length === 0 ? (
              <EmptyState title="لا توجد مهام" description="استرخِ واستمتع بوقتك." />
            ) : (
